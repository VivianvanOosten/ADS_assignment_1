...
We use the mse function from lab 4 to get the mean squared error of a certain formula. 
```{r}
...
best_formula <- formulas_4[which.min(mses_4)]
best_formula
```
...
tibble(
  ...
  ggplot(aes(x = y_pred, y = factor(y_true))) +
